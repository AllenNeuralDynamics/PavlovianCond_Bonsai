...
Data acquisition code that generates data in this format is stored in this repo.

## Relationship to aind-data-schema
rig.json and session.json define the experimental conditions.
Corresponidng mapper can be found here: [behavior](https://github.com/AllenNeuralDynamics/aind-metadata-mapper/tree/dev/src/aind_metadata_mapper/pavlovian_behavior),
[fip](https://github.com/AllenNeuralDynamics/aind-metadata-mapper/tree/dev/src/aind_metadata_mapper/fip)
